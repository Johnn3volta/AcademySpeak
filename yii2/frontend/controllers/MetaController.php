...
class MetaController extends Controller{
    ...
    protected function setMeta($title = null,$description = null,$keywords = null, $type = null,$robots = 'index,follow'){
        ...
        $this->getView()->registerLinkTag(['rel' => 'canonical','href' => Yii::$app->request->referrer]);
        ...
        $this->getView()->registerMetaTag(['property' => 'og:url','content' => Yii::$app->request->referrer]);
        ...
        $this->getView()->registerMetaTag(['name' => 'theme-color','content' => '#202225']);
    }
